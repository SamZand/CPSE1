...
loop:
    ...
    bl 		buffer   
    add 	r5, #1				//index++ voor de compressed_data pointer
    b 		loop
...
decompressLoop:
	...
	sub		r7, #1				// r7 length--
	bne 	decompressLoop
	add 	r5, #1 				// wanneer r7 == 1 is de compresssion gedaan
	b 		loop				// loop
	
buffer:
	ldr 	r1, =uncompressed	// sla uncompressed pointer op in r1
	mov 	r2, #buffer_length	// laad de buffer lengte in r2 (max uncompressed size)
